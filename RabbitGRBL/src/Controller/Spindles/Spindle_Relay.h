...
class Spindle_Relay : public Spindle
{
public:
    Spindle_Relay() = default;

    Spindle_Relay(const Spindle_Relay &) = delete;
    Spindle_Relay(Spindle_Relay &&) = delete;
    Spindle_Relay &operator=(const Spindle_Relay &) = delete;
    Spindle_Relay &operator=(Spindle_Relay &&) = delete;
    ...
    ~Spindle_Relay() override = default;
