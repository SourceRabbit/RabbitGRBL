...
class Spindle_Laser : public Spindle_PWM
{
public:
  Spindle_Laser() = default;

  Spindle_Laser(const Spindle_Laser &) = delete;
  Spindle_Laser(Spindle_Laser &&) = delete;
  Spindle_Laser &operator=(const Spindle_Laser &) = delete;
  Spindle_Laser &operator=(Spindle_Laser &&) = delete;

  void Initialize() override;
  void Dispose() override;
  bool inLaserMode() override;

  ~Spindle_Laser() override = default;
};