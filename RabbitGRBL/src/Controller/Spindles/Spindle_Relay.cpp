...
uint32_t Spindle_Relay::setRPM(uint32_t rpm)
{
...
void Spindle_Relay::setState(SpindleState state, uint32_t rpm)
{
    if (sys.abort)
    {
...
SpindleState Spindle_Relay::getState()
{
...
void Spindle_Relay::setDirectionPinValue(bool clockwise)
{
    if (fDirectionPin == UNDEFINED_PIN)
    {
        return;
