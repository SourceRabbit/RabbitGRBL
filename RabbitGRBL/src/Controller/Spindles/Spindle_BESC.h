...
class Spindle_BESC : public Spindle_PWM
{
public:
    Spindle_BESC() = default;

    Spindle_BESC(const Spindle_BESC &) = delete;
    Spindle_BESC(Spindle_BESC &&) = delete;
    Spindle_BESC &operator=(const Spindle_BESC &) = delete;
    Spindle_BESC &operator=(Spindle_BESC &&) = delete;

    void Initialize() override;

    ~Spindle_BESC() override = default;
};