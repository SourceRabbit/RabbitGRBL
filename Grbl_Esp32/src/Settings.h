...
public:
    WebCommand(const char *description,
               ...
               bool (*cmdChecker)()) : Command(description, type, permissions, grblName, name, cmdChecker),
                                       _action(action) {}
    ...
    WebCommand(const char *description,
               ...
               const char *grblName,
               const char *name,
               Error (*action)(char *, WebUI::AuthenticationLevel)) : WebCommand(description, type, permissions, grblName, name, action, idleOrAlarm) {}
